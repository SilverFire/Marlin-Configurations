...
#define STRING_CONFIG_H_AUTHOR "SilverFire" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FBG 4S"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.1 }
